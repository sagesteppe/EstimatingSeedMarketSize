...
Bootstrap resampling from density functions based on the empirical distributions. 
...
Usage of dependencies minimizes the number of fields respondents interact with  
...
::: {.column width='50%'}
Benefits  
  - Not buying seed from 3^rd^ parties  
...
- Extreme Value Theory - associate sizes, and probabilities with unseen events.    
- Markov chain for fire return intervals  
