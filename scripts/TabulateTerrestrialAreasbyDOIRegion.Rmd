...
To estimate the amount of native seed required by each DOI region via the simulations several constants are required. 
These constants largely reflect the amount of terrestrial area per DOI region, and how these surfaces are parsed between administrative agencies. 
