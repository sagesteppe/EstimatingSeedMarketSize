...
lapply(regs[1], CalculateReturnIntervals)


log(regs[[1]]$TotalArea_Acre) # -inf on missing data. 

log(regs[[10]]$TotalArea_Acre) 

# 1, 4, 10 are problematic 

fevd( log1p(c(0:10)) )

ak <- filter(annual, REG_NAME == 'Upper Colorado Basin' & NoFire > 0)

# generate a plot showing the computed return intervals. 
CalculateReturnIntervals(ak)
