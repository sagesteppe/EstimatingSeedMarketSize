...
The following plot is intended for internal use only (i.e. it's really ugly), essentially it is for determing where a 'gap' exists between the 0.95 wuantile, and extreme value predictions for that quantile and upwards. 
...
ggplot(dat, aes(x = Tau, y = Prediction, color = region, shape = method, size = method)) + 
  ...
  theme_bw() + 
  labs(title = 'Relationships between Quantile and Extreme Value Predictions',
