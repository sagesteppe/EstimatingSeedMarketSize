...
Finally we will also linearly interpolate the growthchart so that we can sample from it using weights, and have a similar number of rows per quantile distance. 
...
all_quants <- function(x){
  ...
  des_res <- seq(0.01, 0.95, by = 0.001)
