...
bnch <- bench::mark(
  outtie <- BurnedAreasSimulator(
    historic = ak, extremes = frid, sims = 1000, years = 3, recalc_extremes = 'every') # 'every is failing when many
)
...
niner <- quantregGrowth::gcrq(form.sm, data=d2, tau = 0.9)
