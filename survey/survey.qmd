...
sd_question('numeric', paste0('Graminoids', '12-51', 'area'), paste('51', 'Graminoids'))
sd_question('numeric', paste0('Graminoids', '12-71', 'area'), paste('71', 'Graminoids'))
sd_question('numeric', paste0('Graminoids', '12-81', 'area'), paste('81', 'Graminoids'))
sd_question('numeric', paste0('Forbs', '12-51', 'area'), paste('51', 'Forbs'))
sd_question('numeric', paste0('Forbs', '12-71', 'area'), paste('71', 'Forbs'))
sd_question('numeric', paste0('Forbs', '12-81', 'area'), paste('81', 'Forbs'))
sd_question('numeric', paste0('Shrubs', '12-51', 'area'), paste('51', 'Shrubs'))
sd_question('numeric', paste0('Shrubs', '12-71', 'area'), paste('71', 'Shrubs'))
sd_question('numeric', paste0('Shrubs', '12-81', 'area'), paste('81', 'Shrubs'))
sd_question('numeric', paste0('Trees', '12-51', 'area'), paste('51', 'Trees'))
sd_question('numeric', paste0('Trees', '12-71', 'area'), paste('71', 'Trees'))
sd_question('numeric', paste0('Trees', '12-81', 'area'), paste('81', 'Trees'))
...
sd_question('numeric', paste0('Graminoids', '12-51', 'proportion'), paste('51', 'Graminoids'))
sd_question('numeric', paste0('Graminoids', '12-71', 'proportion'), paste('71', 'Graminoids'))
sd_question('numeric', paste0('Graminoids', '12-81', 'proportion'), paste('81', 'Graminoids'))
sd_question('numeric', paste0('Forbs', '12-51', 'proportion'), paste('51', 'Forbs'))
sd_question('numeric', paste0('Forbs', '12-71', 'proportion'), paste('71', 'Forbs'))
sd_question('numeric', paste0('Forbs', '12-81', 'proportion'), paste('81', 'Forbs'))
sd_question('numeric', paste0('Shrubs', '12-51', 'proportion'), paste('51', 'Shrubs'))
sd_question('numeric', paste0('Shrubs', '12-71', 'proportion'), paste('71', 'Shrubs'))
sd_question('numeric', paste0('Shrubs', '12-81', 'proportion'), paste('81', 'Shrubs'))
sd_question('numeric', paste0('Trees', '12-51', 'proportion'), paste('51', 'Trees'))
sd_question('numeric', paste0('Trees', '12-71', 'proportion'), paste('71', 'Trees'))
sd_question('numeric', paste0('Trees', '12-81', 'proportion'), paste('81', 'Trees'))
...
```{r}
sd_question('numeric', paste0('Linnaea_borealis', '-', 12, '-realized-area'), 'Proportion of Area?')
sd_question('numeric', paste0('Linnaea_borealis', '-', 12, '-realized-prop'), 'Proportion of Seedmix?')
```
...
```{r}
sd_question('numeric', paste0('Linnaea_borealis', '-', 12, '-desired-area'), 'Proportion of Area?')
sd_question('numeric', paste0('Linnaea_borealis', '-', 12, '-desired-prop'), 'Proportion of Seedmix?')
```
...
<center>Realized</center>
```{r}
sd_question('numeric', paste0('Pumpkin_eater', '-', 12, '-realized-area'), 'Proportion of Area?')
sd_question('numeric', paste0('Pumpkin_eater', '-', 12, '-realized-prop'), 'Proportion of Seedmix?')
```
...
<center>Desired</center>
```{r}
sd_question('numeric', paste0('Pumpkin_eater', '-', 12, '-desired-area'), 'Proportion of Area?')
sd_question('numeric', paste0('Pumpkin_eater', '-', 12, '-desired-prop'), 'Proportion of Seedmix?')
```
