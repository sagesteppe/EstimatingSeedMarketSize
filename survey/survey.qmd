...
sd_question(type  = "numeric", id = paste0("Dryas octopetala", region, '-', nlcd[1], "area"), label = "Forbs:")
sd_question(type  = "numeric", id = paste0("Elymus elymoides", region, '-', nlcd[2], "area"), label = "Forbs:")
```
